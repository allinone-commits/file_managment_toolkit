...
def batch_rename_in_folder(folder, prefix):
    try:
        ...
        print(f"Error in batch_rename_in_folder: {e}")
...
def organize_files_by_type(folder_path):
    try:
        ...
        print(f"Error in organize_files_by_type: {e}")
...
def convert_files(folder_path, choice=None):
    try:
        ...
        print(f"Error in convert_files: {e}")
...
def handle_duplicates(folder):
    try:
        ...
        print(f"Error in handle_duplicates: {e}")
...
def unlock_file(file_path, password):
    try:
        ...
        print(f"Error in unlock_file: {e}")
